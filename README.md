...
Los archivos de los pipelines de prueba están en la carpeta PipelinesJhipster
...
To build the final jar and optimize the proyBaseAngMvn application for production, run:
