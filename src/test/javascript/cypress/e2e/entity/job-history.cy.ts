...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2023-01-19T01:38').blur().should('have.value', '2023-01-19T01:38');

      cy.get(`[data-cy="endDate"]`).type('2023-01-18T08:35').blur().should('have.value', '2023-01-18T08:35');
